...
describe("About Applying What We Have Learnt", function() {
  ...
  it("should add all the natural numbers below 1000 that are multiples of 3 or 5 (functional)", function () {
    ...
    var sum = _.range(1, 1000).reduce( function ( a , b ){  if( b % 3 === 0 || b % 5 === 0 ){ return a+b} else {return a}; } , 0) ; 

    //sum = _.range(1, 1000).filter(function(x) {return x % 3 === 0 || x % 5 === 0}).reduce(function( memo,  x) { return memo + x },0);
